...
export function createTonejsAdapter(): ToneEngine {
  ...
  function getSquareSynth(): ToneType.PolySynth {
    if (!squareSynth) {
      squareSynth = new _tone!.PolySynth(_tone!.Synth, {
  ...
  function getBellSynth(): ToneType.PolySynth {
    if (!bellSynth) {
      bellSynth = new _tone!.PolySynth(_tone!.FMSynth, {
  ...
  function getKeyboardSynth(): ToneType.PolySynth {
    if (!keyboardSynth) {
      keyboardSynth = new _tone!.PolySynth(_tone!.FMSynth, {
  ...
  function getTuningSynth(): ToneType.PolySynth {
    if (!tuningSynth) {
      tuningSynth = new _tone!.PolySynth(_tone!.Synth, {
  ...
  function getTuningSynth2(): ToneType.PolySynth {
    if (!tuningSynth2) {
      tuningSynth2 = new _tone!.PolySynth(_tone!.Synth, {
